...
class PairStatistics(object):
    ...
    * elapsed time
    ...
    def output(self, epoch, batch, n_batches, start):
        ...
        """
        t = self.elapsed_time()
        print(("Epoch %2d, %5d/%5d; acc: %6.2f; ppl: %6.2f; rouge: %1.3f; " +
...
class PairTrainer(object):
    ...
    def __init__(self, model,
                 train_loss, valid_loss, optim,rouge_weight=1,
        ...
        self.rouge_loss=nn.BCEWithLogitsLoss()
    ...
    def train(self, train_iter, epoch, report_func=None):
        ...
        """
        total_stats = PairStatistics()
        report_stats = PairStatistics()
        idx = 0
        truebatch = []
        accum = 0
        normalization = 0
        ...
        for i, batch_ in enumerate(train_iter):
            ...
            report_stats.add_rouge_loss(rouge_loss)
    ...
    def validate(self, valid_iter):
        ...
        for batch in valid_iter:
            ...
            rouge_loss=loss.data[0]
            stats.add_rouge_loss(rouge_loss)
            # Update statistics.
